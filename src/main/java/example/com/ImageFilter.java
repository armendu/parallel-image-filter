...
/**
 * Iterative nine-point image convolution filter working on linearized image. In
 * each of the NRSTEPS iteration steps, the average RGB-value of each pixel in
 * the source array is computed taking into account the pixel and its 8 neighbor
